...
def p3p_grunert(pts_world: np.ndarray, pts_img_cam: np.ndarray) -> List[CameraPose]:
    ...
    a3 = 4 * (a_sq_minus_c_sq_div_b_sq * (1 - a_sq_minus_c_sq_div_b_sq) * cos_beta
              - (1 - a_sq_plus_c_sq_div_b_sq) * cos_alpha * cos_gamma
              + 2 * c_sq / b_sq * cos_alpha_sq * cos_beta)
    a2 = 2 * ((a_sq_minus_c_sq_div_b_sq) ** 2 - 1
    ...
    a1 = 4 * (-(a_sq_minus_c_sq_div_b_sq) * (1 + a_sq_minus_c_sq_div_b_sq) * cos_beta
    ...
    def get_points_in_cam_frame_from_v(v):
        u = ((-1 + a_sq_minus_c_sq_div_b_sq) * v ** 2
             - 2 * (a_sq_minus_c_sq_div_b_sq) * cos_beta * v + 1 + a_sq_minus_c_sq_div_b_sq) \
